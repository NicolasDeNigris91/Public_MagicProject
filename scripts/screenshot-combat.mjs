...
const OUT = resolve('C:/Users/Nicolas De Nigris/Desktop/MyPersonalWebSite/public/projects/magic');
...
async function playFirstHandCard() {
  const card = page
    .locator('section[aria-label^="Your hand"] button[aria-label*="mana cost"]')
    .first();
